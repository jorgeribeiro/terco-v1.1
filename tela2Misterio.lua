...
function scene:create( event )
	...
	local background = display.newImage( "tela2Misterio.png" )
	...
	local botao3Misterio = widget.newButton
		{
			id = "botao3Misterio",
			defaultFile = "botao3Misterio.png",
			overFile = "botao3Misterioover.png",
			onRelease = function() composer.gotoScene( "tela3Misterio", "fade", 100 )
			end
		}
		botao3Misterio.x = display.contentCenterX + 115
		botao3Misterio.y = display.contentCenterY + 215

	sceneGroup:insert( botao3Misterio )
	
	print( "Tela 2o Misterio: criada!" )
end
...
function scene:show( event )
	...
	if phase == "did" then
		print( "Tela 2o Misterio: mostrada!" )
...
function scene:destroy( event )
	local sceneGroup = self.view
	print( "Tela 2o Misterio: destruida!" )
end
