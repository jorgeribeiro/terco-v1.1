...
function scene:create( event )
	...
	local background = display.newImage( "tela4Misterio.png" )
	...
	local botaoVolta = widget.newButton
		{
			...
			onRelease = function() composer.gotoScene( "tela3Misterio", "fade", 100 )		
			end
		}
	...
	local botao5Misterio = widget.newButton
		{
			id = "botao5Misterio",
			defaultFile = "botao5Misterio.png",
			overFile = "botao5Misterioover.png",
			onRelease = function() composer.gotoScene( "tela5Misterio", "fade", 100 )
			end
		}
		botao5Misterio.x = display.contentCenterX + 115
		botao5Misterio.y = display.contentCenterY + 215

	sceneGroup:insert( botao5Misterio )
	
	print( "Tela 4o Misterio: criada!" )
end
...
function scene:show( event )
	...
	if phase == "did" then
		print( "Tela 4o Misterio: mostrada!" )
...
function scene:destroy( event )
	local sceneGroup = self.view
	print( "Tela 4o Misterio: destruida!" )
end
