...
function scene:create( event )
	...
	local background = display.newImage( "tela5Misterio.png" )
	...
	local botaoDeussanto = display.newImage( "botaoDeussanto.png" )
	botaoDeussanto.x = display.contentCenterX
	botaoDeussanto.y = display.contentCenterY + 210

	sceneGroup:insert( botaoDeussanto )
	
	function botaoDeussanto:tap( event )
		local alert = native.showAlert( "Deus Santo", "Deus Santo, Deus Forte, Deus Imortal, tende piedade de nós e do mundo inteiro. (3 vezes) Amém.", { "OK" }, onTap ) 
	end
	botaoDeussanto:addEventListener( "tap", botaoDeussanto )
	...
	local botaoVolta = widget.newButton
		{
			...
			onRelease = function() composer.gotoScene( "tela4Misterio", "fade", 100 )		
			end
		}
	...
	local botaoInicio = widget.newButton
		{
			id = "botaoInicio",
			defaultFile = "botaoInicio.png",
			overFile = "botaoInicioover.png",
			onRelease = function() composer.gotoScene( "telaInicial", "fade", 100 )
			end
		}
		botaoInicio.x = display.contentCenterX + 115
		botaoInicio.y = display.contentCenterY + 215

	sceneGroup:insert( botaoInicio )
	
	print( "Tela 5o Misterio: criada!" )
end
...
function scene:show( event )
	...
	if phase == "did" then
		print( "Tela 5o Misterio: mostrada!" )
...
function scene:destroy( event )
	local sceneGroup = self.view
	print( "Tela 5o Misterio: destruida!" )
end
