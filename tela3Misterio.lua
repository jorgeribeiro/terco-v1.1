...
function scene:create( event )
	...
	local background = display.newImage( "tela3Misterio.png" )
	...
	local botao4Misterio = widget.newButton
		{
			id = "botao4Misterio",
			defaultFile = "botao4Misterio.png",
			overFile = "botao4Misterioover.png",
			onRelease = function() composer.gotoScene( "tela4Misterio", "fade", 100 )
			end
		}
		botao4Misterio.x = display.contentCenterX + 115
		botao4Misterio.y = display.contentCenterY + 215

	sceneGroup:insert( botao4Misterio )
	
	print( "Tela 3o Misterio: criada!" )
end
...
function scene:show( event )
	...
	if phase == "did" then
		print( "Tela 3o Misterio: mostrada!" )
...
function scene:destroy( event )
	local sceneGroup = self.view
	print( "Tela 3o Misterio: destruida!" )
end
