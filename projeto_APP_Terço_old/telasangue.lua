...
function scene:create( event )
	...
	print( "Tela Sangue: event created" )
end
...
function scene:show( event )
	...
	if  phase == "did"  then
		print( "Tela Sangue: show event, phase did" )
		previousScene = composer.getSceneName( "previous" )
		composer.removeScene( "previousScene" )
		print( "Tela Sangue: Previous Scene: destroy" )
		local background = display.newImage("telasangue.png", display.contentCenterX, display.contentCenterY)
...
function scene:hide( event )
	local phase = event.phase
	if phase == "will" then
		print( "Tela Sangue: hide event, phase will" )
	end
end

--Destroy the scene
function scene:destroy( event )
	print( "((destroying Tela Sangue's view))" )
end
